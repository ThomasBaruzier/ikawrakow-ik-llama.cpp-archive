...
👤 **imweijh** commented on **2025-07-28** at **09:13:04**
...
👤 **sayap** commented on **2025-07-29** at **02:21:51**
...
👤 **iSevenDays** commented on **2025-07-29** at **07:32:26**

@sayap thank you for the bug report for Qwen3 model!
There is an issue with Qwen3 when using tool calls.

Could you please check this PR https://github.com/ikawrakow/ik_llama.cpp/pull/661 ? I've added additional tests to make sure we follow original llama.cpp logic for tool parsing and that it will not come up again as regression.
