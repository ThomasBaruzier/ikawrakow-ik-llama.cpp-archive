...
👤 **ikawrakow** commented on **2025-08-27** at **16:02:23**

We now have a CUDA implementation for quite a few row-interleaved quants, so this POC PR does not need to stay open.