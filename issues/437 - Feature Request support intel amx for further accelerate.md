...
👤 **chrislawso** commented on **2025-11-02** at **06:50:48**
...
Hi,
I am newb trying to learn. Can anyone provide any links or information to read more on why AMX is unlikely and/or limited in improvements? 

@ikawrakow If you want access to intel AMX machine with 1 or more gpu lmk what operating system you want installed on it and where to send you credentials.

Thanks

---

👤 **ubergarm** commented on **2025-11-03** at **17:54:52**

@chrislawso  

Check out this interaction I had with the intel dev, mingfeima,  who added some AMX support into mainline lcpp here: https://github.com/ggml-org/llama.cpp/issues/12003#issuecomment-2731484813

I saw mingfeima was also involved on this sglang paper with intel pytorch team: https://lmsys.org/blog/2025-07-14-intel-xeon-optimization/

fwiw ik has added some optimizations that really improved prompt processing (prefill) performance making use of real 512 bit avx512_vnni instructions with kernels that works across a variety of quantization types. i'm not sure the specific amx instructions are able to boost performance across a variety of quantization types so easily or better than other existing instructions.

multi-numa is still an issue in general, as accessing memory across socket<->memory numa is *much* slower regardless of intel xeon or amd epyc.