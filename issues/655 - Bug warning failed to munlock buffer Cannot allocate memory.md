...
👤 **ikawrakow** commented on **2025-08-01** at **15:00:50**

Not sure.

Do you gain something by using jemalloc?

---

👤 **magikRUKKOLA** commented on **2025-08-21** at **13:45:08**

> Do you gain something by using jemalloc?

May be about 15MB of RAM.  But the jemalloc is unrelated -- I can reproduce it without the jemalloc, with the default memory manager.

---

👤 **ikawrakow** commented on **2025-08-22** at **16:51:11**

So, we perform a system call (`munlock`), which fails. The "Cannot allocate memory" is the system error string.  Nothing we can do about it. 

But I also think that if you run the latest `ik_llama.cpp` you will not see this message.

---

👤 **ikawrakow** commented on **2025-08-27** at **15:30:19**
