...
> 👤 **ad-astra-video** replied on **2025-07-31** at **15:14:32**
> 
> Curious, does `--membind=0` and using cores from the other processor provide speed up? I was messing with Kimi K2 on an old xeon server and I saw some speed up adding more cores with keeping the memory allocated on one node.
