## 🗣️ [Discussion #562](https://github.com/ikawrakow/ik_llama.cpp/discussions/562) - AMD GPU Vulkan & ROCm/HIP Discussion
...
> 👤 **firecoperana** replied on **2025-06-29** at **19:53:41**
> 
...
> 👤 **ikawrakow** replied on **2025-07-02** at **06:28:28**
> 
> @jeffbolznv 
> 
...
👤 **narikm** commented on **2025-08-06** at **01:27:42**
...
> 👤 **ikawrakow** replied on **2025-08-06** at **05:03:51**
> 
> IQX_K quants are not implemented yet on Vulkan. Hence, the calculation runs on the CPU, and because the tensors you loaded in VRAM need to be copied to RAM, it is slower than running CPU-only. The -fmoe option is also not implemented on Vulkan yet.

> 👤 **narikm** replied on **2025-08-06** at **21:46:58**
> 
> > IQX_K quants are not implemented yet on Vulkan. Hence, the calculation runs on the CPU, and because the tensors you loaded in VRAM need to be copied to RAM, it is slower than running CPU-only. The -fmoe option is also not implemented on Vulkan yet.
> 
> Thanks for the perfect explanation! Is that implementation projected in the future ?

> 👤 **ikawrakow** replied on **2025-08-07** at **08:36:15**
> 
> There is Discussion [#590](https://github.com/ikawrakow/ik_llama.cpp/issues/590). Based on the results of the poll, I feel compelled to put some effort into adding `ik_llama.cpp` specific additions/optimizations into the Vulkan back-end. But having never done any Vulkan development before, this may take some time.

> 👤 **0cc4m** replied on **2025-08-07** at **08:49:27**
> 
> I'm available for questions once you start looking into it. The basic programming model is similar to CUDA, but the Vulkan API is much more verbose and requires a ton of boilerplate, and writing kernels (called compute shaders for us) in GLSL is more tedious due to a custom syntax (based on C), lack of C++ features and lack of pointer casting that is used extensively in CUDA and Metal backends.

> 👤 **ikawrakow** replied on **2025-08-07** at **09:09:12**
> 
> @0cc4m Thank you! I'm sure I will make use of the offer.

> 👤 **ikawrakow** replied on **2025-08-07** at **11:40:55**
> 
> @0cc4m 
> 
...
> 👤 **0cc4m** replied on **2025-08-07** at **12:15:22**
> 
...
> ```
> 
> Note the same binding index. We use this to conditionally load vectors of floats or individual floats. If your data types don't align, you can use `uint8_t` as input data type, combine the correct ones into an uint32_t and cast to a float using [uintBitsToFloat](https://registry.khronos.org/OpenGL-Refpages/gl4/html/intBitsToFloat.xhtml).
> 
...
> 👤 **ikawrakow** replied on **2025-08-07** at **12:39:24**
> 
...
> 👤 **0cc4m** replied on **2025-08-07** at **13:07:14**
> 
...
> 
> Source [VkPhysicalDeviceLimits](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceLimits.html), many devices require 16-byte alignment here.
> 
